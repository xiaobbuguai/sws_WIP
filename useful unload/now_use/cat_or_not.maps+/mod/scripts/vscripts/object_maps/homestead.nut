...
void function EntitiesDidLoad()
{
    ...
    CreateSimpleButton( <5279, 1716, 22>, <0, 0, 0>, "to summon sarah briggs", callback_SarahBriggsButtonTriggered )
    CreateSimpleButton( <5279, 1716, 16>, <0, 0, 0>, "to summon viper", callback_ValidateVoperRequest , 1.0 )
