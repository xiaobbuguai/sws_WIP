...
void function placeGlitchObjects()
{
    ...
    CreateSimpleButton( < -167, 97, -55 >, <0, 75, 0>, "領養寵物", callback_ButtonPetTriggered )
    CreateSimpleButton( < -167, 97, -105 >, <0, 75, 0>, "抽獎", callback_ButtonGambleTriggered, 7.0 )
    CreateSimpleButton( < -167, 97, -355 >, <0, 75, 0>, "to leave", teleport_from, 1.0 )
