...
void function placeWarGameObjects()
{
    ...
    CreateSimpleButton( <339.102, -371.695, -127.969>, <0, 90, 0>, "to control the bridge", callback_ButtonTriggered ) // was z 66
...
void function CreateAshPeaceKraberSeller( vector origin, vector angles )
{
    ...
    prop.SetUsePrompts( "按 %use% 拿一把ASH從APEX帶回來的和平捍衛者", "按 %use% 拿一把ASH從APEX帶回來的和平捍衛者" )
