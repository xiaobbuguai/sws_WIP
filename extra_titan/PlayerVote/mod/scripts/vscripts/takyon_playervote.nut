...
void function OnPilotBecomesTitaned(entity player, entity titan) {
    thread OnPilotBecomesTitan_Threaded( player, titan )
}

void function OnPilotBecomesTitan_Threaded( entity player, entity titan )
{
    player.EndSignal( "OnDestroy" )
    wait 3 // wait for gamemode announcement
